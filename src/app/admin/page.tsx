                ...
                filteredReservations.map((reservation) => (
                  <div key={reservation.id} className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-stone-100">
                    <div className="flex items-start justify-between mb-6">
                      ...
                      <div className="flex gap-2">
                        <Button
                          ...
                          variant="outline"
                          size="sm"
                          className="border-stone-300 hover:border-green-600 hover:bg-green-50"
                        >
                        ...
                        {reservation.status !== 'in-progress' && reservation.status !== 'completed' && (
                          <Button
                            onClick={() => updateReservationStatus(reservation.id, 'in-progress')}
                            variant="outline"
                            size="sm"
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3 text-stone-600">
                          ...
                          <span className="font-medium">
                            {reservation.guests <= 80 ? '1 salón' : 
                             reservation.guests <= 200 ? '2 salones' :
                             reservation.guests <= 300 ? '3 salones' : '4 salones'}
                          </span>
                        </div>
                      </div>
                      ...
                      <div className="space-y-3">
                        <div className="text-xs text-stone-500">
                          <p>Creada: {reservation.createdAt}</p>
                        </div>
                        <div className="text-xs text-stone-500">
                    ...
                    <div className="bg-stone-50 rounded-xl p-4">
                      <h4 className="font-semibold text-stone-800 mb-3">Desglose de Precios</h4>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-xs text-stone-500">({reservation.duration} horas × $3,000 MX)</p>
                        </div>
                      </div>
                    </div>
                  </div>
